system.time({
  ...
  gm$builder <- gm$builder$readData(file.path='C:\\Users\\Gire\\Desktop\\TumorEvolution_project\\Tables\\20140317.TCGA.246FreezeSamples.PMs.txt', sample.column='sample')
